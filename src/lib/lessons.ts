...
const PT_VARIED_PHRASES: [string,string,string][] = [
  ...
  ["Preciso ir para a escola.","rotina"],
  ["Estou indo para o trabalho.","rotina"],
  ["Tenho uma reunião hoje.","trabalho"],
  ["Por favor, envie o e-mail.","trabalho"],
  ["Preciso de mais tempo.","trabalho"],
  ["A loja está aberta.","compras"],
  ["A loja está fechada.","compras"],
  ["Vocês aceitam dinheiro?","pagamento"],
  ["Preciso de uma passagem.","transporte"],
  ["Qual ônibus vai para o centro?","transporte"],
  ["O ônibus está atrasado.","transporte"],
  ["Perdi o trem.","transporte"],
  ["Preciso de um mapa.","direções"],
  ["É longe daqui?","direções"],
  ["Fica perto da estação.","direções"],
  ["Vamos nos encontrar amanhã.","encontro"],
  ["Até mais tarde.","despedida"],
