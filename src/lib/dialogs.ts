...
const CATS: { id: string; emoji: string; name: string; rows: Row[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["Até amanhã de manhã.", "See you tomorrow morning.", "また明日の朝。", "Mata ashita no asa.", "fechar", 7],
      ["Obrigado por hoje.", "Thank you for today.", "今日はありがとうございました。", "Kyō wa arigatō gozaimashita.", "agradecer", 0],
    ],
  },
  {
    id: "cumprimentos", emoji: "👋", name: "Cumprimentos",
    rows: [
      ["Olá!", "Hello!", "こんにちは！", "Konnichiwa!", "comum", 1],
  ...
  },
  {
    ...
    rows: [
      ...
      ["Descanse bem.", "Get some rest.", "ゆっくり休んでください。", "Yukkuri yasunde kudasai.", "comum", 6],
  ...
  },
  {
    ...
    rows: [
      ...
      ["Aceita cartão?", "Do you take card?", "カードは使えますか？", "Kādo wa tsukaemasu ka?", "informacao", 5],
  ...
  },
  {
    ...
    rows: [
      ...
      ["Muito obrigado!", "Thank you very much!", "ありがとうございました！", "Arigatō gozaimashita!", "agradecer", 7],
    ],
  },
  {
    ...
    rows: [
      ...
      ["Tem em outra cor?", "Do you have another color?", "他の色はありますか？", "Hoka no iro wa arimasu ka?", "informacao", 7],
  ...
  },
  {
    ...
    rows: [
      ...
      ["Claro, sem problema.", "Sure, no problem.", "はい、大丈夫です。", "Hai, daijōbu desu.", "comum", 4],
