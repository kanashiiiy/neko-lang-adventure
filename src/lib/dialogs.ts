...
const CATS: { id: string; emoji: string; name: string; rows: Row[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["Preciso recarregar meu cartão.", "I need to top up my card.", "カードにチャージしたいです。", "Kādo ni chāji shitai desu.", "comum", 5],
  ...
  },
  {
    ...
    rows: [
      ...
      ["Vamos almoçar todos juntos no domingo.", "We're all having lunch together on Sunday.", "日曜日に家族全員で昼ごはんを食べます。", "Nichiyōbi ni kazoku zen'in de hirugohan o shimasu.", "informal", 5],
